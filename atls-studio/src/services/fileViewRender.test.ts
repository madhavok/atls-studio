...
describe('fileViewRender — renderFileViewBlock', () => {
  it('renders header with retention hash, skeleton rows, and closing fence', () => {
    ...
    // Single ref per FileView — `injectSnapshotHashes` resolves sourceRevision for cite slots.
