 ...
 * Drops freshness explanations that duplicate runtime labels ([FRESH], [STALE], stale_hash errors).
 * Keeps: operational edit mechanics, change justification, verify cadence.
 */
